...
public class KeyboardControl : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if ( Input.GetKeyDown( KeyCode.G ) ) {
            graspCld.GraspingCylinder = !graspCld.GraspingCylinder;
        }

        // grasp Card
        if (Input.GetKeyDown(KeyCode.H))
        {
            graspCrd.GraspingCard = !graspCrd.GraspingCard;
        }

        //grasp Stick
        if (Input.GetKeyDown(KeyCode.J))
        {
            graspStk.GraspingStick = !graspStk.GraspingStick;
        }

        //grasp Tripod
        if (Input.GetKeyDown(KeyCode.K))
        {
            graspTri.GraspingTripod = !graspTri.GraspingTripod;
        }
